...
public class RandomDriver extends AbstractDriver {
    ...
    public RandomDriver(Scheduler scheduler, Planner planner, RipperInput ripperInput, RipperOutput ripperOutput,
        ...
        this.statesList = new ActivityStateList(new ActivityStructureComparator());
    ...
    public void rippingLoop() {
        ...
        ActivityDescription previousActivity = null;
                ...
                try {
                    ...
                    do {
                        ...
                        if (activity != null) {
                            ...
                            updateFSM(previousActivity, t, activity);
    ...
    private void updateFSM(ActivityDescription previousActivity, Task t, ActivityDescription newStateDescription) {
        if (previousActivity != null) {
            ...
            // update FSM
            fsmCollector.updateState(previousActivity, evt, newStateDescription);
