 ...
 */
@SuppressLint("NewApi")
public class SimpleNoValuesExtractor implements IExtractor {
	/**
	 * Robot Instance
	 */
	IRobot robot = null;
	 ...
	 *            Robot Instance
	 */
	public SimpleNoValuesExtractor(IRobot robot) {
		this.robot = robot;
	}
...
//						}
	...
	private boolean isTabActivity(Activity activity) {
		return android.app.TabActivity.class.isAssignableFrom(activity.getClass());
	}
